...
import priceBanner from 'assets/kid_pics/price_card.png'

// Summer2022
const PRICE_MONTHLY_DATA = [
  {
    recommended: null,
    title: 'Summer Running Camp',
    icon: priceBanner,
    amount: '$15 per session',
    options: [
      {
        status: true,
        label: 'A fun and challenging camp with fitness, speed, and strength training.'
      }
      // {
      //   status: true,
